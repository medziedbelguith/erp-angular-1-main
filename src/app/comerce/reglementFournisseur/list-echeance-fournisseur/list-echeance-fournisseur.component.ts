...
@Component({
  selector: 'app-list-echeance-fournisseur',
  templateUrl: './list-echeance-fournisseur.component.html',
  styleUrls: ['./list-echeance-fournisseur.component.scss']
})
export class ListEcheanceFournisseurComponent implements OnInit {

  formC:FormGroup

  lienDelete = "/reglementFournisseurs/deleteReglementFournisseur"
  lienList = "/reglementFournisseurs/listEcheances"
  ...
  gotToAdd(){
    this.router.navigate(['reglementFournisseur/ajout']);
  }

...
@Component({
  ...
  styleUrls: ['./list-reglement-fournisseur.component.scss']
})
export class ListReglementFournisseurComponent implements OnInit {
  ...
  lienList = "/reglementFournisseurs/listReglementFournisseurs"
  ...
  goToListEcheance(){
    this.router.navigate(['reglementFournisseur/echeanceFournisseur']);
  }

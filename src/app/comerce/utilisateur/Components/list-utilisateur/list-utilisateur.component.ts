...
export class ListUtilisateurComponent implements OnInit {
  ...
  constructor(private utilite:UtiliteService, private fonctionPartagesService:FonctionPartagesService, private apiUtilisateurService:ApiUtilisateurService, private fb: FormBuilder, private router: Router, private http: HttpClient, public informationGenerale: InformationsService) {
  ...
  getUtilisateurs() {
    ...
    this.apiUtilisateurService.list(this.request).subscribe(
      ...
      res => {
        ...
        alert("Désole, ilya un problème de connexion internet vvvvvv")
      }
    );
  }

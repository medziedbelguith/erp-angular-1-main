...
@Component({
  selector: 'app-ligne-btravails',
  templateUrl: './ligne-btravails.component.html',
  styleUrls: ['./ligne-btravails.component.scss']
})
export class LigneBTravailsComponent implements OnInit {

...
export class ListMarqueComponent implements OnInit {
  ...
  getMarques() {
    ...
    this.marqueSer.getAll(this.request)
    .subscribe(
      res => {
        this.isLoading = false
        let resultat: any = res
        if (resultat.status) {
          this.marques = resultat.resultat.docs
  ...
  deleteItem(){
    ...
    this.isLoading = true
    this.marqueSer.delete(this.idDeleteModal)
    .subscribe(
      res => {
        this.isLoading = false
        let resultat: any = res
  ...
  printout() {
    this.utilite.printout(this.marques, this.items, this.titreFile)
  }

  generatePDF() {
    this.utilite.generatePDF(this.marques, this.items, this.titreFile, this.nameFile)
  }
  
  exportexcel() {
    /* table id is passed over here */
    this.utilite.exportexcel(this.marques, this.items, this.titreFile, this.nameFile)
  }
  ...
  openModalModifier(id){
    ...
    this.typeElement = this.fonctionPartagesService.titreOfModal.modifierMarque
    this.isOpenModalAjoutElement = true
  }  

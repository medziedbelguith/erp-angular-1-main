...
@Component({
  selector: 'app-details-mode-reglement',
  templateUrl: './details-mode-reglement.component.html',
  styleUrls: ['./details-mode-reglement.component.scss']
})
export class DetailsModeReglementComponent implements OnInit {

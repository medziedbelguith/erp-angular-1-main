...
@Component({
  selector: 'app-bon-livraison-devis-convertion',
  templateUrl: './bon-livraison-devis-convertion.component.html',
  styleUrls: ['./bon-livraison-devis-convertion.component.scss']
})
export class BonLivraisonDevisConvertionComponent implements OnInit {

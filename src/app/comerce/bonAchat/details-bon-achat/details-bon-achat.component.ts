...
@Component({
  selector: 'app-details-bon-achat',
  templateUrl: './details-bon-achat.component.html',
  styleUrls: ['./details-bon-achat.component.scss']
})
export class DetailsBonAchatComponent implements OnInit {

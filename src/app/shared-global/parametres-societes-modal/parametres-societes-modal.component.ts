      ...
      res => {
        ...
        if (resultat.status) {
          ...
          if(this.societes.length == 1){
            this.informationsServices.idSocieteCurrent = this.societes[0].id                
            this.informationsServices.societeCurrent = this.societes[0].raisonSociale
            this.closeAdd()
          }
          ...
          if(!isFound){
            this.informationsServices.societeCurrent = ""
            this.informationsServices.idSocieteCurrent = ""
          }
